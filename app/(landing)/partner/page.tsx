...
function ByeByeScammers() {
  return (
    <section
      ...
      id="Index"
    >
      <div className="flex flex-col items-center justify-start w-full max-w-[90rem] space-y-5">
...
function Index() {
  return (
    <section
      ...
      id="Index"
    >
      <div className="flex xl:flex-row flex-col items-center xl:justify-between justify-start space-y-10 xl:space-y-0 w-full max-w-[90rem] px-5 py-10 xl:px-16">
        <div className="flex flex-col xl:items-start items-center justify-center space-y-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 pt-5">
            <Button asChild variant="success">
              <Link href="https://partner.reachgig.com">
                Start your Journey
              </Link>
            </Button>
            {/* <Button asChild variant="outline">
