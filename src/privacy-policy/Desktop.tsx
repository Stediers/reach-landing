...
export default function Desktop() {
  const title = "text-3xl";
  const subtitle = "text-2xl";
  const body = "w-full flex flex-col space-y-10 leading-7";
  const section = "w-full flex flex-col space-y-5 ";
  const heading1 = "text-xl";
  const heading2 = "text-lg my-2";
  ...
  return (
    <DesktopWrapper className="flex w-full">
      <div className={body}>
        <div className={title}>
