...
export default function Desktop() {
  const title = "text-xl";
  const subtitle = "text-lg";
  const body = "w-full flex flex-col space-y-10 leading-7 text-center";
  const body_text = "";
  const section = "w-full flex flex-col space-y-5 justify-center items-center";
  const heading1 = "text-lg text-center";
  const heading2 = "text-md";
      ...
      <div className={body}>
        ...
        <div className={section}>
          ...
          <div>
            ...
            you may email us at connect@reachgig&#46;com&#46;
          </div>
        </div>
        <div className={section}>
        ...
        <div className={section}>
          ...
          <div>
            ...
            email us at connect@reachgig&#46;com or&nbsp;contact us by
            phone&#58; &#43;917550083900
          </div>
        </div>
        <div className={section}>
          ...
          <div>
            ...
            &#44; please visit&#58; reachgig&#46;com/data-request&#46;
          </div>
        </div>
      </div>
    </MobileWrapper>
